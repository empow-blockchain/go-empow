...
var buyCmd = &cobra.Command{
  ...
  iwallet sys buy 100 --account test0 --ram_receiver test1`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		return saveOrSendAction("ram.empow", "buy", accountName, other, amount)
	},
}
...
var sellCmd = &cobra.Command{
  ...
  iwallet sys sell 100 --account test0 --token_receiver test1`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		amount, _ := strconv.ParseFloat(args[0], 64)
		return saveOrSendAction("ram.empow", "sell", accountName, other, amount)
	},
}
...
var rtransCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		return saveOrSendAction("ram.empow", "lend", accountName, args[0], amount)
	},
}
