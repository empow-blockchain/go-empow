...
var addpermCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		return saveOrSendAction("auth.empow", "addPermission", accountName, args[0], threshold)
	},
}
...
var droppermCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		return saveOrSendAction("auth.empow", "dropPermission", accountName, args[0])
	},
}
...
var assignPermCmd = &cobra.Command{
  ...
  iwallet sys assignperm myactive EhNiaU4DzUmjCrvynV3gaUeuj2VjB1v2DCmbGD5U2nSE 50`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		return saveOrSendAction("auth.empow", "assignPermission", accountName, args[0], args[1], threshold)
	},
}
...
var revokePermCmd = &cobra.Command{
  ...
  iwallet sys revokeperm myactive EhNiaU4DzUmjCrvynV3gaUeuj2VjB1v2DCmbGD5U2nSE`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		return saveOrSendAction("auth.empow", "revokePermission", accountName, args[0], args[1])
	},
}
...
var addgroupCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		return saveOrSendAction("auth.empow", "addGroup", accountName, args[0])
	},
}
...
var dropgroupCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		return saveOrSendAction("auth.empow", "dropGroup", accountName, args[0])
	},
}
...
var assignGroupCmd = &cobra.Command{
  ...
  iwallet sys assignperm myactive EhNiaU4DzUmjCrvynV3gaUeuj2VjB1v2DCmbGD5U2nSE 50`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		return saveOrSendAction("auth.empow", "assignGroup", accountName, args[0], args[1], threshold)
	},
}
...
var revokeGroupCmd = &cobra.Command{
  ...
  iwallet sys revokeperm myactive EhNiaU4DzUmjCrvynV3gaUeuj2VjB1v2DCmbGD5U2nSE`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		return saveOrSendAction("auth.empow", "revokeGroup", accountName, args[0], args[1])
	},
}
...
var bindPermCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		return saveOrSendAction("auth.empow", "assignPermissionToGroup", accountName, args[0], args[1])
	},
}
...
var unbindPermCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		return saveOrSendAction("auth.empow", "revokePermissionInGroup", accountName, args[0], args[1])
	},
}
