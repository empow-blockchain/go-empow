...
var callCmd = &cobra.Command{
	...
	Example: `  iwallet call "token.empow" "transfer" '["em","user0001","user0002","123.45",""]' --address EM2ZsDPRrJHHKgc7w719Ds9X9Z7QCcuMB4bFxMynDR2TYfQqt
  iwallet call "token.empow" "transfer" '["em","user0001","user0002","123.45",""]' --output tx.json`,
