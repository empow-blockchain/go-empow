...
(function () {
    ...
    String.prototype.charAt = function() {
        _EMPOWInstruction_counter.incr(1);
    ...
    String.prototype.constructor = function() {
        _EMPOWInstruction_counter.incr(1 + this.length * 0.1);
    ...
    String.prototype.concat = function() {
        ...
        _EMPOWInstruction_counter.incr(1 + res.length * 0.1);
        return res;
    };
    ...
    String.prototype.includes = function() {
        ...
        _EMPOWInstruction_counter.incr(1 + s.length * 0.1);
    ...
    Math.abs = function() {
        _EMPOWInstruction_counter.incr(2);
    ...
    Array.prototype.constructor = function() {
        ...
        _EMPOWInstruction_counter.incr(1 + res.length * 0.2);
        return res;
    };

    const ArraytoString = Array.prototype.toString;
    Array.prototype.toString = function() {
        _EMPOWInstruction_counter.incr(1 + this.length);
    ...
    Array.prototype.concat = function() {
        ...
        _EMPOWInstruction_counter.incr(1 + res.length);
        return res;
    };
    ...
    Array.prototype.filter = function() {
        _EMPOWInstruction_counter.incr(1 + this.length * 10);
    ...
    Array.prototype.indexOf = function() {
        _EMPOWInstruction_counter.incr(1 + this.length * 0.2);
    ...
    Array.prototype.splice = function() {
        ...
        if (arguments.length >= 3) {
            _EMPOWInstruction_counter.incr(arguments.length - 2);
        }
    ...
    JSON.parse = function () {
        if (arguments[0] === undefined || arguments[0] === null) {
            _EMPOWInstruction_counter.incr(10);
        } else {
            _EMPOWInstruction_counter.incr(10 + Stringconstructor(arguments[0]).length);
        }
    ...
    JSON.stringify = function () {
        ...
        _EMPOWInstruction_counter.incr(10 + rs.length);
        return rs;
    };
    */
    ...
    // Native
    EMPOWBlockchain = null;
    EMPOWInstruction = null;
    EMPOWStorage = null;
    _EMPOWCrypto = null;
    _native_log = null;
    _native_run = null;
    ...
    BigNumber.prototype.constructor = function() {
        _EMPOWInstruction_counter.incr(20);
    ...
    BigNumber.prototype.dividedBy = BigNumber.prototype.div = function() {
        if (arguments[0] == null) {
            _EMPOWInstruction_counter.incr(20 + BigNumbertoString.call(this).length * 10);
        } else {
            let argStr = (arguments[0] instanceof OrigBigNumber) ? BigNumbertoString.call(arguments[0]) : Stringconstructor(arguments[0]);
            _EMPOWInstruction_counter.incr(20 + (BigNumbertoString.call(this).length + argStr.length) * 10);
        }
    ...
    BigNumber.prototype.integerValue = function() {
        _EMPOWInstruction_counter.incr(20 + BigNumbertoString.call(this).length * 4);
    ...
    BigNumber.prototype.isEqualTo = BigNumber.prototype.eq = function() {
        if (arguments[0] == null) {
            _EMPOWInstruction_counter.incr(20 + BigNumbertoString.call(this).length * 2);
        } else {
            let argStr = (arguments[0] instanceof OrigBigNumber) ? BigNumbertoString.call(arguments[0]) : Stringconstructor(arguments[0]);
            _EMPOWInstruction_counter.incr(20 + (BigNumbertoString.call(this).length + argStr.length) * 2);
        }
    ...
    BigNumber.prototype.multipliedBy = BigNumber.prototype.times = function() {
        if (arguments[0] == null) {
            ...
            let argStr = (arguments[0] instanceof OrigBigNumber) ? BigNumbertoString.call(arguments[0]) : Stringconstructor(arguments[0]);
            _EMPOWInstruction_counter.incr(20 + (BigNumbertoString.call(this).length + argStr.length) * 4);
        }
